...
/**
 * Servlet implementation class RecipePostLikeServlet
 */
@WebServlet("/recipe/recipeOnePostLike.do")
public class RecipePostLikeServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RecipePostLikeServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
			...
			int result=rService.postLike(boardNo,likeNum);
