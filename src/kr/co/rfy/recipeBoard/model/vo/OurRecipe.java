...
public class OurRecipe {
	...
	public OurRecipe(String userId, String userName, int boardNo, String title, String subTitle, String levelName,
			String timeName, String filePath, int likeNum, String levelCode, String cookCode) {
		super();
		this.userId = userId;
