...
/**
 * Servlet implementation class memberEndYnChangeUp
 */
@WebServlet("/admin/memberEndYNChangeUp.do")
public class memberEndYnChangeUp extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public memberEndYnChangeUp() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher view = request.getRequestDispatcher("/views/admin/updateMemberBlackYNUp.jsp");
