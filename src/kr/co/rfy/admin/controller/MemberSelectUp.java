...
/**
 * Servlet implementation class MemberSelectUp
 */
@WebServlet("/admin/memberSelectUp.do")
public class MemberSelectUp extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MemberSelectUp() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher view = request.getRequestDispatcher("/views/admin/memberSelectUp.jsp");
