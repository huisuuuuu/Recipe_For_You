...
/**
 * Servlet implementation class MemberSearchBlackUp
 */
@WebServlet("/admin/MemberSearchBlackUP.do")
public class MemberSearchBlackUp extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MemberSearchBlackUp() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		HashMap<String,Object> map = adService.SearchMemberBlackUp(currentPage,keyword,type); 
