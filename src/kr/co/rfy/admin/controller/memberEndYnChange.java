...
/**
 * Servlet implementation class memberEndYnChange
 */
@WebServlet("/admin/memberEndYNChange.do")
public class memberEndYnChange extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public memberEndYnChange() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		//이 요청을 수행한 사람의 권한 확인(최고 권한 관리자인지 아닌지)
				...
				RequestDispatcher view = request.getRequestDispatcher("/views/admin/updateMemberBlackYN.jsp");
