...
/**
 * Servlet implementation class MemberAllListUpServlet
 */
@WebServlet("/admin/memberAllListUp.do")
public class MemberAllListUpServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MemberAllListUpServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		HashMap<String, Object> pageDataMap = adService.selectAllMemberListUp(currentPage);

		// 가져온 회원정보를 가지고, jsp(view) 페이지로이동
		RequestDispatcher view = request.getRequestDispatcher("/views/admin/memberAllListUp.jsp");
