...
/**
 * Servlet implementation class memberEndYnChangeBlackUp
 */
@WebServlet("/admin/memberEndYNChangeBlackUp.do")
public class memberEndYnChangeBlackUp extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public memberEndYnChangeBlackUp() {
        super();
...
String roll = MemberAuthorityCheck.authorityRootCheck(request, response);
		...
		int result = adService.updateMemberBlackYNUp(userNo,blackYN);
		
		RequestDispatcher view = request.getRequestDispatcher("/views/admin/updateMemberBlackYNUpBlack.jsp");
