...
/**
 * Servlet implementation class AdminRecipeBoardPostSearchServlet
 */
@WebServlet("/recipeBoard/recipeBoardPostSearch.do")
public class AdminRecipeBoardPostSearchServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public AdminRecipeBoardPostSearchServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		HashMap<String,Object> map = rbService.selectSearchPost(currentPage, keyword, type);
