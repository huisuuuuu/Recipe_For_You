...
<form action="/admin/MemberSearchUP.do" method="get" id="search">
...
<%if(!list.isEmpty()) { %>
	...
	<thead>
		<tr>
			<th>
			회원번호
		<a href="/admin/memberAllList.do" class="UpDown"><i class="fas fa-angle-down" style="color:black;"></i></a>
		...
		<%}else { %>
			...
			<%} %>
				...
				<%if(m.getEnd_YN()=='N'){ %>
				<td><a class="link" href="/admin/memberSelectUp.do?userNo=<%=m.getUser_No() %>&currentPage=<%=currentPage%>" ><%=m.getUser_Name() %></a></td>
				<%}else{ %>
