...
<br>
				...
				<a href="/admin/memberEndYNChangeBlackUp.do?userNo=<%=m.getUser_No()%>&blackYN=<%=m.getBlack_YN()%>">
				<button style="width:100%" class="button"><%if(m.getBlack_YN()=='Y'){ %>
				블랙
				<%}else{ %>
				정상<%} %></button></a>
			...
			<br>
				<a href="/admin/blackListUp.do?currentPage=<%=currentPage%>" class="back">취소</a><br>
</div>
<script>
