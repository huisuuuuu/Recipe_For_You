	...
	<div id="wrapper">
		<div class="header fixed-top">
			<div class="top">
				<div class=top-img>
					<img
						src="${pageContext.request.contextPath}/assets/common/images/topicon.png"
						alt="" width="18px" height="25px">
				</div>
				<span class="top1 align">마이냉장고에 나만의 식재료를 등록하고 레시피를 추천 받아 보세요!</span>
			</div>
			<div class="header1">
				<a href="" class="logo"> <img
					src="${pageContext.request.contextPath}/assets/common/images/main logo.png"
					alt="">
				</a>
				<div class="box-user">
					<a href="" class="mypage"> <img
						src="${pageContext.request.contextPath}/assets/common/images/headericon1.png"
						alt="" width="23px" height="28px">
					</a> <a href="/views/member/memberLogin.jsp" class="login"> <img
						src="${pageContext.request.contextPath}/assets/common/images/headericon2.png"
						alt="" width="80px" height="30px">
					</a>
				</div>
				...
				<nav class="navbar navbar-expand-lg nav-distance">
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<ul class="navbar-nav me-auto mb-2 mb-lg-0">
							<li class="nav-item"><a class="nav-link active nav-about"
								href="#">ABOUT</a></li>
							...
							<li class="nav-item"><a class="nav-link active nav-mypage"
								href="${pageContext.request.contextPath}/mybox/myboxList.do">마이냉장고</a>
							</li>
						</ul>
					</div>
				</nav>
